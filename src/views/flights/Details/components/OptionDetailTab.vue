    ...
    <div v-if="Array.isArray(flight)">
        <b-tabs nav-class="nav nav-pills nav-justified nav-responsive bg-primary bg-opacity-10 rounded p-2 mb-3">
            <b-tab>
                ...
                <div v-if="getAllSegments().length === 1">
                    <div v-for="(offerSegment, segidx) in getAllSegments()" :key="segidx">
                            ...
                            <div class="d-sm-flex justify-content-sm-between align-items-center">
                                ...
                                <div class="d-flex mb-2 mb-sm-0">
                                    ...
                                    <h6 class="fw-normal mb-0">
                                        ...
                                        {{ getAirlineName(offerSegment.MarketingAirline) }} ({{ offerSegment.FlightNum
                                            || 'SA-1254' }})
                                        ({{ offerSegment.FlightNum || 'SA-1254' }})
                                    </h6>
                                </div>
                                <h6 class="fw-normal mb-0"><span class="text-body">Ангилал:</span> {{
                        ...
                        <b-card-body class="p-4">
                            ...
                            <div v-if="offerSegment.Baggage"
                                class="card-footer d-flex justify-content-end align-items-end w-100">
                ...
                <div v-else v-for="(offerSegment, segidxs) in getAllSegments()" :key="segidxs">
                    <div class="d-flex ">
                        <div class="d-flex p-2 align-items-center fw-medium">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-center">
                                ...
                                <!-- Дунд Repeat дүрс -->
                                <div v-if="segidxs < getAllSegmentsDates().length - 1"
                        ...
                        <div class="w-100">
                            <b-card-header>
                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                    ...
                                    <div class="d-flex mb-2 mb-sm-0">
                                        ...
                                        <h6 class="fw-normal mb-0">
                                            {{Array.isArray(StoreAirCompany) ? StoreAirCompany.find((airline: any) =>
                                                airline.Code ===
                            ...
                            <b-card-body class="p-4 pb-3">
                                ...
                                <div v-if="offerSegment.Baggage"
                                    class="d-flex justify-content-end align-items-end w-100 mt-3">
                                    <div class="d-flex mx-2 me-5">
                                        <Briefcase class="mx-2" color="#3949AB" />
                                        Гар тээш: ({{ offerSegment.Baggage.Count }})-{{ offerSegment.Baggage.BaggageType
                                        }}
                            ...
                            <div v-if="segidxs < getAllSegmentsDates().length - 1"
                                ...
                                <div class="d-flex flex-row bg-light rounded-2 w-100 justify-content-between">
                                    <div class="text-start fw-normal rounded-2 p-2 text-orange">
                                        ...
                                        дээр
                                        {{ timeDifference(offerSegment.Arrival.Date, getAllSegmentsDates()[segidxs
                                            +
                                            1].Departure.Date)
                                        }}
                                        хүлээнэ
                    ...
                    <div v-if="Array.isArray(StoreflightInfos[index].Offers.OfferInfo)">
                        <div v-for="(offer, idx) in StoreflightInfos[index].Offers.OfferInfo" :key="idx">
                            <div v-if="Array.isArray(offer.Segments.OfferSegment)">
                                <div v-if="StoreflightInfos[index].Offers.OfferInfo.length === 1 && StoreflightInfos[index].Offers.OfferInfo[0].Segments.OfferSegment.length === 1"
                                            ...
                                            <div class="table-responsive-lg">
                                                <table class="table caption-bottom mb-0">
                                                    ...
                                                    <thead class="table-dark">
                                                        <tr>
                                                            <th scope="col" class="border-0 rounded-start">Ачаа тээшийн
                                                                төрөл</th>
                                                    ...
                                                    <tbody class="border-top-0"
                                                        v-if="offerSegment.Baggage || offerSegment.CabinBaggage">
                                ...
                                <div v-else v-for="(offerSegment, segidxs) in offer.Segments.OfferSegment"
                                    :key="segidxs">
                                    <b-card no-body class="border mb-3">
                                        <b-card-header class="d-flex align-items-center border-bottom">
                                            <img :src="offerSegment.MarketingAirline
...
// Access state
const StoreflightInfos = computed(() => optionStore.optionInfos?.result?.Body?.AeroPrebookResponse?.AeroPrebookResult || []);
const StoreAirCompany = computed(() => flightStore.AirCompany);
const StoreAirPorts = computed(() => flightStore.AirPorts);

const getFlightData = () => {
    return StoreflightInfos.value || { Offers: { OfferInfo: [] } };
};
...
const getFirstDeparture = () => getAllSegments()[0]?.Departure.Iata || "N/A";
const getFirstDepartureTime = () => getAllSegments()[0]?.Departure.Date || "N/A";
const getLastArrival = () => getAllSegments().slice(-1)[0]?.Arrival.Iata || "N/A";
const getLastArrivalTime = () => getAllSegments().slice(-1)[0]?.Arrival.Date || "N/A";
