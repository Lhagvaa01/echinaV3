<template>
  ...
  <b-container class="main-container">
    <div class="rounded-3 p-3 p-sm-5">
      ...
      <form class="bg-mode position-relative  shadow-lg px-3 px-sm-4 pt-4 mb-4 mb-sm-0 rounded-4 p-3">
...
// Тухайн огноог "д.д.ж.ж" (day.month.year) форматаар хувиргах функц
